defmodule InventoryWeb.UserAuthTest do
  use InventoryWeb.ConnCase, async: true

  alias Inventory.Accounts
  alias InventoryWeb.UserAuth
  import Inventory.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, InventoryWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      InventoryWeb.Endpoint.subscribe(live_socket_id)
